...
originally it will generate random trees of logarthmic heights 
for star graph :  u = 1 ,v = random 
for line graph :   u = i-1 , v=  i
for binary tree :  u= i/2 , v= i ;
...
int rand(int a,int b){
    return a+ r.nextInt(1000000)%(b-a+1);
}
...
public static void main(String[] args) throws Exception {
     seed  = args.length > 0 ? Integer.parseInt(args[0]): 1;
